...
4টি থিমে মোট **40টি জোড়া** আছে — আলো, অন্ধকার, আর বেশি
...
| ফোল্ডার | কী আছে |
|---|---|
| `09_guidebook/` | **নির্দেশিকা।** বাংলা ও ইংরেজিতে 14টি অধ্যায়, একটি ফাইলেই (14.3 মেগাবাইট), ইন্টারনেট ছাড়াই চলে। সঙ্গে 1.5 মেগাবাইটের PDF |
| `07_tokens/` | ডিজাইন টোকেন — DTCG সূত্র, আর তা থেকে বানানো 63টি CSS প্রপার্টি |
