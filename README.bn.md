...
4টি থিমে মোট **48টি জোড়া** আছে — আলো, অন্ধকার, আর বেশি
...
- **লেখার জন্য 28টি জোড়া।** সবচেয়ে কম **5.1623:1** —
...
| ফোল্ডার | কী আছে |
|---|---|
| `09_guidebook/` | **নির্দেশিকা।** বাংলা ও ইংরেজিতে 14টি অধ্যায়, একটি ফাইলেই (15.4 মেগাবাইট), ইন্টারনেট ছাড়াই চলে। সঙ্গে 1.9 মেগাবাইটের PDF |
| `07_tokens/` | ডিজাইন টোকেন — DTCG সূত্র, আর তা থেকে বানানো 66টি CSS প্রপার্টি |
| `08_components/` | 30টি উপাদান ও নকশার কার্ড |
| `04_mark/` | চিহ্ন, নামলিপি আর আইকনের 18টি ফাইল |
