...
// tokens SHA-256 44005ba5204a1bbeff738d424cd6ad1d3d023aa9e56cc42f14ae678a363042bf
"use strict";
(() => {
  ...
  var BUNDLE_SHA256 = "44005ba5204a1bbeff738d424cd6ad1d3d023aa9e56cc42f14ae678a363042bf";
  var SOURCE_HASHES = {
  ...
  var BUNDLED = {
    ...
    markManifest: {
      ...
      "checks": [
        ...
        "icon at stroke 9: mark 65.0\xD773.0 scaled \xD70.9208, worst corner 45.00 of 45 units from centre \u2014 inside both the 90-unit field and the circle watchOS and visionOS mask to",
        "icon at stroke 15: mark 71.0\xD779.0 scaled \xD70.8473, worst corner 45.00 of 45 units from centre \u2014 inside both the 90-unit field and the circle watchOS and visionOS mask to",
