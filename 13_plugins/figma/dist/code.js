...
// tokens SHA-256 d626af6df16c93f74995a295ed43a9e1cee49d8e3485774e98b45969151668aa
"use strict";
(() => {
  ...
  function buildPlan(input) {
    ...
    for (const path of semanticPaths) {
      ...
      themeVars.push({
        name: path,
        resolvedType: "COLOR",
        description: description || "One of the seventeen semantic colour roles. Each mode holds the value measured for that theme.",
        values
      });
    }
    const collections = [
    ...
    decisions.push({
      ...
      why: 'The seventeen semantic roles include no "on accent" or "on danger" text colour, so the label colour on a filled button is not defined anywhere in the system. An outlined button uses only roles that were measured: the label sits on a surface, which is exactly the pairing the colour engine checked.'
    });
    decisions.push({
  ...
  var BUNDLE_SHA256 = "d626af6df16c93f74995a295ed43a9e1cee49d8e3485774e98b45969151668aa";
  var SOURCE_HASHES = {
