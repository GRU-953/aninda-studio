...
export const BUNDLED: RawInput = {
  ...
  "fontFamily": {
    ...
    "latin": {
      ...
      "$description": "Literata, by Veronika Burian and José Scaglione (TypeTogether). An optical-size axis from 7 to 72, so the letterforms are redrawn for the size rather than merely scaled. Its x-height is almost flat across that range (0.5166 to 0.5130 em).",
      "$extensions": {
        "studio.aninda": {
          "licence": "SIL OFL 1.1"
        }
  ...
  "strokes": {
    ...
    "stroke_by_file": {
      ...
      "icon-512.svg": 9.0,
      "icon-192.svg": 9.0,
      "icon-1024-black-on-white.svg": 9.0,
      "icon-1024-white-on-black.svg": 9.0,
      "icon-square-1024-black-on-white.svg": 9.0,
