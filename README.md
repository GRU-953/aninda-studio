...
There are **48 colour role and theme pairings** across
...
| `15_native/` | Swift and Kotlin — the tokens, 16 SwiftUI components, a Compose theme, and the 8 patterns as screens on both, 71 files in all, compiled by the build that gates them |
...
20 generators, in dependency order. Each step reads the output of
